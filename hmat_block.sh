...
\
colin = util.imgRead('/home/lab-x399-2/Documents/fMRI_preprocessing/colin27_t1_tal_lin_cropped.nii') \
atlas = util.imgRead('/home/lab-x399-2/Documents/fMRI_preprocessing/HMAT.nii') \
...
atlas_affine_up = ndreg.imgApplyAffine(atlas, final_transform) \
atlas_lddmm_up = ndreg.imgApplyField(atlas_affine_up, field_up) \
\
util.imgWrite(atlas_affine_up, '$output_dir/HMAT_in_struct.nii' )\
